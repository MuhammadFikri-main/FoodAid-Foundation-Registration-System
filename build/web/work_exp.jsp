<%-- 
    Document   : work_exp
    Created on : May 9, 2019, 10:21:49 AM
    Author     : Fikri
--%>
...
<html>
    ...
    <body>
        <div class="content">
            <!-- Multistep Form -->
            <div class="main">
        <form action="work_exp" method="post">
            <!-- Progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset id="first">
                            ...
                            <div class="base">
                                ...
                                <input type="text" id="datepicker" name="year_from"><br>
                                To<br>
                                <div class="fs-subtitle">(e.g. dd-mm-yyyy)</div>
                                <input type="text" id="datepicker2" name="year_to" ><br>
                                Last Drawn Salary<br>
                                <div class="fs-subtitle">(e.g. RM XXX++)</div>
                                <input type="text" name="last_salary" title="please fill with required format e.g. RM XXX"><br>
                                Reason For Leaving<br>
                                <input type="text" name="leave_reason" ><br>
